...
function CardIcon({ type }) {
  // “Immagini” di oggi: icone SVG (non devi caricare file)
  if (type === "recovery") {
    return (
  ...
  if (type === "grounding") {
    return (
      <svg viewBox="0 0 120 80" className="h-full w-full">
        ...
        <path
          d="M38 44c8-14 36-14 44 0"
          fill="#111827"
          opacity="0.25"
        />
        <path
          d="M44 44c6-10 26-10 32 0"
          fill="#111827"
          opacity="0.35"
        />
      </svg>
  ...
  return (
    <svg viewBox="0 0 120 80" className="h-full w-full">
      ...
      <path
        d="M90 50c-6 0-10-4-10-10 6 0 10 4 10 10Z"
        fill="#111827"
        opacity="0.25"
      />
      <path
        d="M86 56c-8 0-14-6-14-14 8 0 14 6 14 14Z"
        fill="#111827"
        opacity="0.2"
      />
    </svg>
    ...
    <div className="mx-auto max-w-6xl px-4 py-14">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-5 text-base text-gray-600 md:text-lg">
          Ogni oggetto qui ha una logica. Scopriamo, selezioniamo e presentiamo prodotti di
          alta qualità legati al benessere, alla cura personale e alla vita quotidiana.
        </p>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        <Link
          href="/health"
          className="group rounded-2xl border bg-white p-4 shadow-sm hover:shadow"
        >
        ...
        >
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Oggetti di presenza: gesto lento, materiali, senso.
            </p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Filiera, logica, uso consapevole. Zero “miracoli”.
            </p>
          </div>
        </Link>
      </div>
