  ...
  const items = [
    {
      ...
      img: "/images/headphones-vintage.webp",
      url: "PASTE_EBAY_URL_HERE", // esempio: https://www.ebay.co.uk/itm/XXXXXXXX
      price: "£39.90",
      desc: "Design retrò con driver moderni."
    },
    {
      title: "Orologio Classic Quartz",
      img: "/images/watch-classic.webp",
      url: "PASTE_EBAY_URL_HERE",
      price: "£49.00",
      desc: "Eleganza minimal, cinturino in pelle."
    },
    {
      title: "Retro Console Portable",
      img: "/images/retro-console.webp",
      url: "PASTE_EBAY_URL_HERE",
      price: "£29.90",
      desc: "400+ giochi classici in tasca."
    },
  ];
  ...
  return (
    <main className="p-8 bg-white text-gray-800">
      ...
      <p className="mb-8 text-gray-600">
        Occasioni autentiche e selezioni smart dal marketplace più dinamico.
      </p>
