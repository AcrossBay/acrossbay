...
export default function Page() {
  ...
  const T = (DICT[lang] ?? DICT.en).pages.made;

  const cards = [
    { key: "leatherBelt", img: "/leather-bag.jpg", href: "/made-in-italy" },
    { key: "linenSet", img: "/linen-shirt.webp", href: "/made-in-italy" },
    { key: "ceramicsSet", img: "/ceramics.jpg", href: "/made-in-italy" },
  ];
