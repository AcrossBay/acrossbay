    ...
    <main style={{ padding: 24, maxWidth: 980, margin: '0 auto' }}>
      <header style={{ marginBottom: 24 }}>
        ...
        <p style={{ marginTop: 10, fontSize: 16, opacity: 0.85 }}>
          Prodotti selezionati. Ordini veloci. Pagamento sicuro.
        </p>
      </header>
      ...
      >
        <h2 style={{ margin: 0, fontSize: 20 }}>Ordina ora</h2>
        <p style={{ marginTop: 10, marginBottom: 16, opacity: 0.85 }}>
          Usa il link di pagamento Stripe per completare l’ordine in pochi secondi.
        </p>
        ...
        <div style={{ marginTop: 14, fontSize: 13, opacity: 0.7 }}>
          Link pagamento: <span style={{ wordBreak: 'break-all' }}>{STRIPE_PAY_LINK}</span>
        </div>
      </section>
    </main>
  );
