...
export default function Page() {
  ...
  const T = (DICT[lang] ?? DICT.en).pages.tiktok;

  const cards = [
    { key: "smartLamp", img: "/lamp-smart.webp", href: "/tiktok" },
    { key: "phoneStand", img: "/projector.jpg", href: "/tiktok" },
    { key: "miniMic", img: "/projector-mini.webp", href: "/tiktok" },
  ];
